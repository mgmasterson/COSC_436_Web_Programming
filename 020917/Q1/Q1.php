...
<div class="gloomy"> Feb 9 2017: Question 1</div>
</head>
<body>
	<center>
		<?php

		//main array for items
		$main = array(
	 	 array("bat",5,3.50),
	 	 array("ball",4,0.50),
	 	 array("base",3,5.00),
	 ...
	 //using array_walk for addition of items
	 $a=array("bat"=>"5","ball"=>"4","base"=>"3","umpire"=>"2","player"=>"4");
